...
const Home = props => (
    <div>
        <div style={{ margin: 'auto', width: '100%', textAlign: 'center', color: 'white' }}>
            ...
            <h4>Looking for a fresh start or a new beginning? Come join Exodus Knights! We are a chill, casual-midcore fc with active raiders, crafters and helpful members!</h4>
            <h4>Events, raffles, and weekly map runs!</h4>
        </div>
